SERVER_CONFIG = {
    "new_name": "☢️ NUKER BY PS99 SCRIPT ☢️",  # New Server Name here      
    "new_icon": "https://pbs.twimg.com/media/GARsLJzWIAAuioX.jpg:large",   # New Server Icon url here → https://yourimage.jpg    
    "new_description": "HAHA",  # New Server Description here    
}

WEBHOOK_CONFIG = {
    "default_name": "☢️ NUKE BY PS99 SCRIPT ☢️",  # Webhook Name here     
}
...
EMBED_CONFIG = {
    "title": "BY PS99 SCRIPT",    # Maine Embed Title here you can change it :3          
